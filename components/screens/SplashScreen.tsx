...
export default function SplashScreen({ onDone }: { onDone: () => void }) {
  ...
  return (
    <div
      className="absolute inset-0 z-50 flex flex-col items-center justify-center bg-[#111111] transition-opacity duration-500"
      style={{ opacity: phase === "out" ? 0 : 1 }}
    >
      {/* Logo */}
      <div
        className="flex flex-col items-center gap-5 transition-all duration-600"
        style={{
